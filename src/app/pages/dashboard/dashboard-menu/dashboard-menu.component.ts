import { Component, OnInit, Sanitizer, ɵSafeHtml } from '@angular/core';
...
export class DashboardMenuComponent implements OnInit  {
  ...
  svgIcons: string[] = [
    ...
    '<svg class="link-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="feather feather-pie-chart" viewBox="0 0 24 24"> <defs /> <path d="M21.21 15.89A10 10 0 118 2.83M22 12A10 10 0 0012 2v10z" /></svg>',
  ...
  setActiveItem(itemNumber: number): void {
    this.activeItem = itemNumber;
    // Puedes agregar más lógica aquí, como navegar a una página específica, etc.
  }

  sanitizeSVG(svgCode: string): ɵSafeHtml {
